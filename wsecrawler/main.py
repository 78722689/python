...
def initparser():
    ...
    parser.add_argument('-k', dest="keywords", help="The keywords to search", type=list, default=[])
...
if __name__ == '__main__':
    ...
    factory.start_crawler(args.keywrds, args.number, args.routines)
